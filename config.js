...
const urlaudiomenu = 'https://f.top4top.io/m_2026xyt7a1.mp3'
...
const backgroundmenuimg = `https://i.ytimg.com/vi/BYcr3tJeS5A/maxresdefault.jpg`
//Link direto da imagem de fundo TAMANHO RECOMENDADO: 1280x720
//Obs: não coloque o texto longo para a imagem não sumir

const backgroundwelcomeimg = `https://i.ytimg.com/vi/BYcr3tJeS5A/maxresdefault.jpg`
//Link direto da imagem de fundo da boas-vindas TAMANHO RECOMENDADO: 1280x720
//Obs: não coloque o texto longo para a imagem não sumir

const backgroundbyeimg = `https://i.ytimg.com/vi/B-aNWwUU7vY/maxresdefault.jpg`
...
const cr = '☄️✨⏤͟͟͞͞ঔৣ͜͡𝖆𝚟𝖆𝖑𝖆𝖓𝖈𝖍𝖊᭄ꦿ BOT☄️\n' 
...
const qnttravahardroleta = 5
// quantidade de travas que mandam no roleta russa hard
// Obs: O valor é multiplicado por 12 ent tenha cuidado

// MENSAGENS DE BOM DIA BOA TARDE E BOA NOITE

const linkimgday = 'https://i.ytimg.com/vi/BYcr3tJeS5A/maxresdefault.jpg'
const textmsgday = 'BOM DIA'
// link e mensagem de bom dia

const linkimgeve = 'https://i.ytimg.com/vi/BYcr3tJeS5A/maxresdefault.jpg'
const textmsgeve = `BOA TARDE☕`
// link e mensagem de boa tarde

const linkimgnig = 'https://i.ytimg.com/vi/BYcr3tJeS5A/maxresdefault.jpg'
...
const botlindo = 'OBRIGADOO'
const linkbotlindo = 'https://www.contioutra.com/content/uploads/2018/05/gatos-capa.jpg'
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:Ian;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=5521981218655:+55 21 981218655\n' 
+ 'END:VCARD'
